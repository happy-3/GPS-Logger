...
class Geomagnetism {
	...
	*	The columns in this file are as follows:	n,	m,	gnm,	hnm,	dgnm,	dhnm*/
    /// The input string array which contains each line of input for the wmm.cof file.
    /// Columns: n, m, gnm, hnm, dgnm, dhnm
    private static let WMM_COF:[String] = [
        ...
        "  5  5      13.3      97.4        1.4       -0.4",
        "  6  0      65.4       0.0       -0.6        0.0",
        "  6  1      65.8     -15.9       -0.6        0.1",
        "  6  2      74.9      23.4        0.2       -1.8",
        "  6  3    -124.1      53.2        1.4       -1.6",
        "  6  4     -36.1     -63.9       -1.4        0.9",
        "  6  5      13.2       9.2       -0.0        0.1",
        "  6  6     -64.6      68.9        0.9        1.0",
        "  7  0      80.5       0.0       -0.1        0.0",
        "  7  1     -75.5     -52.3       -0.5        0.5",
        "  7  2      -8.1     -17.0       -0.1        0.6",
        "  7  3      56.4       4.3        0.8       -0.7",
        "  7  4      16.3      24.8        0.4       -0.3",
        "  7  5       6.5      -2.2       -0.6       -1.2",
        "  7  6      -7.0     -26.3       -0.7        0.1",
        "  7  7       9.7      -1.9        1.0        0.3",
        "  8  0      23.5       0.0       -0.1        0.0",
        "  8  1       9.9       8.1        0.1       -0.2",
        "  8  2     -17.6     -14.4       -0.1        0.7",
        "  8  3      -0.5      12.6        0.5       -0.3",
        "  8  4     -21.2     -11.2       -0.1        0.5",
        "  8  5      15.2      15.0        0.4       -0.4",
        "  8  6      13.5       3.7        0.5       -0.5",
        "  8  7     -16.1      -7.4        0.0        0.4",
        "  8  8      -0.3       3.0        0.4        0.1",
        "  9  0       4.5       0.0       -0.1        0.0",
        "  9  1       7.8     -23.4       -0.3       -0.3",
        "  9  2       2.3      11.1       -0.0        0.2",
        "  9  3      -1.5      10.2        0.4       -0.4",
        "  9  4      -1.4      -4.9       -0.3        0.3",
        "  9  5     -13.3      -6.0       -0.0        0.1",
        "  9  6       1.1       7.7        0.3       -0.0",
        "  9  7       8.7       0.4       -0.0       -0.2",
        "  9  8      -9.3      -1.6       -0.0        0.5",
        "  9  9     -11.8       9.7       -0.4        0.2",
        " 10  0      -1.9       0.0        0.0        0.0",
        " 10  1      -6.2       3.3       -0.0       -0.0",
        " 10  2      -0.1      -0.2       -0.0        0.1",
        " 10  3       1.7       3.4        0.2       -0.3",
        " 10  4      -0.9       4.7       -0.1        0.1",
        " 10  5       0.6      -8.5       -0.2       -0.2",
        " 10  6      -0.8      -0.1       -0.0        0.1",
        " 10  7       1.9      -4.1       -0.1       -0.0",
        " 10  8       1.4      -3.4       -0.2       -0.1",
        " 10  9      -2.4      -0.1       -0.1        0.2",
        " 10 10      -3.9      -8.7       -0.0       -0.0",
        " 11  0       2.9       0.0       -0.0        0.0",
        " 11  1      -1.4      -0.1       -0.1       -0.0",
        " 11  2      -2.5       2.5       -0.0        0.1",
        " 11  3       2.4      -0.5        0.0        0.0",
        " 11  4      -0.9      -0.4       -0.0        0.2",
        " 11  5       0.3       0.6       -0.1       -0.0",
        " 11  6      -0.7      -0.2        0.0        0.0",
        " 11  7      -0.1      -1.7       -0.0        0.1",
        " 11  8       1.4      -1.5       -0.1       -0.0",
        " 11  9      -0.6      -3.0       -0.1       -0.1",
        " 11 10       0.2      -1.9       -0.1        0.0",
        " 11 11       3.1      -2.6       -0.1       -0.0",
        " 12  0      -2.0       0.0        0.0        0.0",
        " 12  1      -0.1      -1.3       -0.0       -0.0",
        " 12  2       0.5       0.6       -0.0        0.0",
        " 12  3       1.3       1.5        0.0       -0.1",
        " 12  4      -1.2      -1.9       -0.0        0.1",
